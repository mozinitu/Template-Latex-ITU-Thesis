...
Praesent fermentum velit ut mauris rutrum dignissim Figure \ref{fig:ch2-1}..
...
\citet{moore91} curabitur sit amet quam quam, vitae accumsan arcu. Sed feugiat, risus non fringilla commodo, nisl eros fringilla ante,
...
consectetur suscipit. Duis eros purus, vehicula ac ullamcorper non, imperdiet eu dolor. Integer nec velit nisl Figure \ref{fig:ch2-2a}, Figure \ref{fig:ch2-2b}, Figure \ref{fig:ch2-2}.
...
\begin{figure}[ht]
	...
	\begin{subfigure}[b]{.8\textwidth}
		...
		\caption{First subcaption of the subfigure.}\label{fig:ch2-2a}
	\end{subfigure}
	\vspace{12pt}
	\vfill
	\begin{subfigure}[b]{.8\textwidth}
		\centering
		\includegraphics[scale=.3]{./fig/sekil1}
		\caption{Second subcaption of the subfigure.}\label{fig:ch2-2b}
	\end{subfigure}
	\caption{An example of subfigure main caption.}\label{fig:ch2-2}
\end{figure}
\vspace{-6pt}
...
\citet*{Wegener2000629} lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac augue vel dui 
...
\citeauthor*{Wegener2000629} (\citeyear{Wegener2000629}) 
...
Table \ref{table:ch2-1} lorem ipsum dolor sit amet. Sed ac augue vel dui 
adipiscing placerat et nec metus. Donec bibendum sodales mollis. Cras in lacus 
justo, at vestibulum quam. Sed semper, est sit amet consectetur ornare, leo est 
lacinia velit, adipiscing elementum lectus felis at sem. Aenean hendrerit erat eu 
lacus malesuada at sodales arcu egestas. Maecenas euismod urna ut sem luctus et 
...
massa aliquet lorem, et varius nisi lacus vel diam. Etiam vitae metus sed orci 
rutrum fringilla. Phasellus sed velit quam. Mauris vestibulum, mauris a cursus 
adipiscing, nulla est hendrerit justo, ut fringilla eros velit ut mauris \cite{Zuckerman199486}.
...
ante ipsum quis turpis. Etiam ligula leo, sodales eget mollis eget, scelerisque 
vitae leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur 
ridiculus mus \citep{Zuckerman199486}. 
...
\begin{longtable}{ccc}
		...
		%table.
		\caption{Feasible triples for highly variable Grid, MLMMH.}\label{Table2.6}\\
		...
		\multicolumn{3}{c}{\textbf{\tablename\ \thetable\ (continued) :} Feasible triples
